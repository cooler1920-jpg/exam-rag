...
def chat_reply(history, namespace=""):
    ...
    prompt = (
        ...
        "- NEVER reply that you 'cannot' do something, that you're 'limited to text', or that you can't "
        "draw charts. The app draws charts and does the maths itself — you just provide the numbers/"
        "answer from the data. Always give the most useful answer you can from the data below.\n"
